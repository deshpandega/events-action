...
wsk -i action update guest/hobbylocale/addCommentToEvent event.zip --kind nodejs:6 --web true --param-file config.json --main=addCommentToEvent
...
wsk -i action get guest/hobbylocale/addCommentToEvent --url